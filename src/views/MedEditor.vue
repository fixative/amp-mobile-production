<template>
  <vss-header hedType="topics" @cancel-modal="cancelModal()">Edit Medication</vss-header>
...
const props = defineProps(['cancelModal','med'])
console.log("MED",props.med)
searchText.value = props.med.name
form.frequency = props.med.frequency;
props.med.times.forEach((time:Date)=>timeList.push(time))
